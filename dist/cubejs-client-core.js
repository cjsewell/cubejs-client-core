...
dayjs__default['default'].locale(_objectSpread$3(_objectSpread$3({}, en__default['default']), {}, {
  weekStart: 1
}));
var TIME_SERIES = {
  ...
  _createClass__default['default'](ResultSet, [{
      ...
      return this.seriesNames(pivotConfig).map(function (_ref9) {
        ...
        return {
          ...
          series: _this.chartPivot(pivotConfig).map(function (_ref10) {
            var x = _ref10.x,
                obj = _objectWithoutProperties__default['default'](_ref10, _excluded$2);
    ...
    value: function timeSeries(timeDimension) {
      ...
      if (!dateRange) {
        ...
        }), ramda.filter(Boolean))(this.timeDimensionBackwardCompatibleData());
  ...
  _createClass__default['default'](HttpTransport, [{
    ...
    value: function request(method, _ref2) {
      ...
      var baseRequestId = _ref2.baseRequestId,
          params = _objectWithoutProperties__default['default'](_ref2, _excluded$1);
...
function defaultHeuristics(newState) {
  ...
  var _clone = ramda.clone(newState),
      query = _clone.query,
      props = _objectWithoutProperties__default['default'](_clone, _excluded);
